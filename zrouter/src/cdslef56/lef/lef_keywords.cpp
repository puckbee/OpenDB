...
void lef_init_symbol_table(void *Keyword_set)
{
    ...
    lef_add_to_stringtab_Int(Keyword_set, "BELOW",	K_BELOW) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "CENTERTOCENTER", K_CENTERTOCENTER) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "CORRECTIONFACTOR",
      K_CORRECTIONFACTOR) ;
    lef_add_to_stringtab_Int(Keyword_set, "CORRECTIONTABLE",
      K_CORRECTIONTABLE) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "CUTSIZE",    K_CUTSIZE) ;
    lef_add_to_stringtab_Int(Keyword_set, "CUTSPACING",    K_CUTSPACING) ;
    lef_add_to_stringtab_Int(Keyword_set, "DATA",    	K_DATA) ;
    lef_add_to_stringtab_Int(Keyword_set, "DATABASE",	K_DATABASE) ;
    lef_add_to_stringtab_Int(Keyword_set, "DCCURRENTDENSITY",
      K_DCCURRENTDENSITY) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "DENSITY", K_DENSITY) ;
    lef_add_to_stringtab_Int(Keyword_set, "DENSITYCHECKSTEP",
      K_DENSITYCHECKSTEP) ;
    lef_add_to_stringtab_Int(Keyword_set, "DENSITYCHECKWINDOW",
      K_DENSITYCHECKWINDOW) ;
    lef_add_to_stringtab_Int(Keyword_set, "DESIGNRULEWIDTH",
      K_DESIGNRULEWIDTH) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "DIAGPITCH", K_DIAGPITCH) ;
    lef_add_to_stringtab_Int(Keyword_set, "DIAGWIDTH",	K_DIAGWIDTH) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "FILLACTIVESPACING",
      K_FILLACTIVESPACING) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "GENERATED",	K_GENERATED) ;
    lef_add_to_stringtab_Int(Keyword_set, "GENERATOR",	K_GENERATOR) ;
    lef_add_to_stringtab_Int(Keyword_set, "GROUND",	K_GROUND) ;
    lef_add_to_stringtab_Int(Keyword_set, "GROUNDSENSITIVITY",
      K_GROUNDSENSITIVITY) ;
    lef_add_to_stringtab_Int(Keyword_set, "HARDSPACING", K_HARDSPACING) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "INPUTNOISEMARGIN",
      K_INPUTNOISEMARGIN) ;
    lef_add_to_stringtab_Int(Keyword_set, "INSIDECORNER", K_INSIDECORNER) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "LAYERS",	K_LAYERS) ;
    lef_add_to_stringtab_Int(Keyword_set, "LEAKAGE",	K_LEAKAGE) ;
    lef_add_to_stringtab_Int(Keyword_set, "LENGTH",     K_LENGTH) ;
    lef_add_to_stringtab_Int(Keyword_set, "LENGTHSUM",  K_LENGTHSUM) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "MAXADJACENTSLOTSPACING",
      K_MAXADJACENTSLOTSPACING) ;
    lef_add_to_stringtab_Int(Keyword_set, "MAXCOAXIALSLOTSPACING",
      K_MAXCOAXIALSLOTSPACING) ;
    lef_add_to_stringtab_Int(Keyword_set, "MAXDELAY",	K_MAXDELAY) ;
    lef_add_to_stringtab_Int(Keyword_set, "MAXEDGESLOTSPACING",
      K_MAXEDGESLOTSPACING) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "MICRONS",	K_MICRONS) ;
    lef_add_to_stringtab_Int(Keyword_set, "MILLIAMPS",	K_MILLIAMPS) ;
    lef_add_to_stringtab_Int(Keyword_set, "MILLIWATTS",	K_MILLIWATTS) ;
    lef_add_to_stringtab_Int(Keyword_set, "MINCUTS",	K_MINCUTS) ;
    lef_add_to_stringtab_Int(Keyword_set, "MINENCLOSEDAREA",
      K_MINENCLOSEDAREA) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "MINSIZE",    K_MINSIZE) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "NETEXPR",	K_NETEXPR) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "OUTPUTRESISTANCE",
      K_OUTPUTRESISTANCE) ;
    lef_add_to_stringtab_Int(Keyword_set, "OUTSIDECORNER", K_OUTSIDECORNER) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "PARALLELRUNLENGTH",
      K_PARALLELRUNLENGTH) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "PREFERENCLOSURE",
      K_PREFERENCLOSURE) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "PROTRUSIONWIDTH",
      K_PROTRUSIONWIDTH) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "ROWCOL",	K_ROWCOL) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "ROWPATTERN", K_ROWPATTERN) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "SOFT",	K_SOFT) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "SUPPLYSENSITIVITY",
      K_SUPPLYSENSITIVITY) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "USEVIA",	K_USEVIA) ;
    lef_add_to_stringtab_Int(Keyword_set, "USEVIARULE",	K_USEVIARULE) ;
    ...
    lef_add_to_stringtab_Int(Keyword_set, "WELLTAP",	K_WELLTAP) ;
