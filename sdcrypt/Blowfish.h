...
public:
	...
	static void CharStr2HexStr(const unsigned char* pucCharStr, 
				   char* pszHexStr, int iSize) ;
	static void HexStr2CharStr(const char* pszHexStr, 
				   unsigned char* pucCharStr, int iSize) ; 
